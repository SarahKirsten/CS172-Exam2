...
int main()
{
	...
	*/
	...
	//Check is we need to add citizens to Spokane
	//Bonus point if you can tell my why I picked these names and Ids ;)
	if (spokane->populationSize() == 0)
	{
		...
		Citizen* antoine = new Citizen(1, "Antoine", "Bizet", "Blue");
